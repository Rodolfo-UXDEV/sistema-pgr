    ...
    const positions: Position[] = [
      {
        ...
        cbo: '7212-15',
        activityDescription: 'Operar tornos mecânicos convencionais e CNC, preparar ferramentas de corte, efetuar medições dimensionais com paquímetro e micrômetro, realizar limpeza e lubrificação básica da máquina e abastecimento de matéria-prima.',
        workerCount: 12,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
      {
        ...
        cbo: '7243-15',
        activityDescription: 'Efetuar soldagem de estruturas metálicas pelo processo MIG/MAG e eletrodo revestido, preparar chanfros e peças com esmerilhadeira, inspecionar cordões de solda e executar acabamentos.',
        workerCount: 8,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      }
